...
(function(){
 ...
 'pgaitch': ["(255, 254, 165)",
    ...
    function intervaldays(start, stop) {
        ...
        days = [];
        while (d1 < d2) {
            days.push(d1.getDate());
            d1.setTime(d1.getTime() + kDayMillisecs);
        }
    ...
    s.renderlinechart = function(chrt, data, width, height) {
        ...
        var x_lbl = intervaldays(startinterval, stopinterval);
        ...
        gr_linechart(canvas, points, x_lbl);
    };

    s.renderheatmap = function(chrt, data, width, height) {
    ...
    s.range = function(start, stop) {
        if (start) {
            startinterval = new Date(start);
            if (stop)
                stopinterval = new Date(stop);
        }
